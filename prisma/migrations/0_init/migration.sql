...
-- CreateEnum
CREATE TYPE "UserRole" AS ENUM ('superadmin', 'admin', 'pharmacist', 'customer');
...
-- CreateIndex
CREATE INDEX "Product_barcode_idx" ON "Product" USING HASH ("barcode");

-- CreateIndex
CREATE INDEX "Product_name_scientificName_description_idx" ON "Product" USING GIN ("name" gin_trgm_ops, "scientificName" gin_trgm_ops, "description" gin_trgm_ops);
...
-- CreateIndex
CREATE INDEX "Expense_pharmacistId_date_idx" ON "Expense"("pharmacistId", "date");
...
-- CreateIndex
CREATE INDEX "Order_orderNumber_idx" ON "Order" USING HASH ("orderNumber");
...
-- CreateIndex
CREATE INDEX "Purchase_invoiceNumber_idx" ON "Purchase" USING HASH ("invoiceNumber");

-- CreateIndex
CREATE UNIQUE INDEX "Return_returnNumber_key" ON "Return"("returnNumber");

-- CreateIndex
CREATE INDEX "Return_returnNumber_idx" ON "Return" USING HASH ("returnNumber");
